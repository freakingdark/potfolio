...
<p>Python-based pipeline for scraping financial articles and performing NLP-based sentiment and readability analysis. Extracts structured metrics such as polarity, subjectivity, and linguistic complexity from unstructured text using BeautifulSoup, NLTK, and pandas.</p>
<a href="/potfolio/projects/blackcoffer-nlp/">View Project</a>
</div>

<div style="border:1px solid #ddd; padding:15px; border-radius:10px;">
<h3>Nonlinear Dynamics Visualizations</h3>
<p>Visualization of complex nonlinear systems and chaotic dynamics using computational physics methods.</p>
<a href="https://github.com/freakingdark/Visualizing_varoius_problems_in_Non_Linear_dynamics-">View Project</a>
</div>

<div style="border:1px solid #ddd; padding:15px; border-radius:10px;">
<h3>Nonlinear Dynamics Master's Project</h3>
<p>Computational exploration of nonlinear systems, chaos theory, and dynamic behavior.</p>
<a href="https://github.com/freakingdark/Nonlinear_Dynamics_Masters_Project">View Project</a>
</div>

<div style="border:1px solid #ddd; padding:15px; border-radius:10px;">
<h3>IBM Data Analyst Capstone</h3>
<p>End-to-end data analysis project involving ETL workflows, EDA, and dashboard visualization.</p>
<a href="https://github.com/freakingdark/IBM_Capstone_project">View Project</a>
</div>

<div style="border:1px solid #ddd; padding:15px; border-radius:10px;">
<h3>ISA Internship Projects</h3>
<p>Collection of analysis tasks and technical work completed during internship training.</p>
<a href="https://github.com/freakingdark/ISA_Internship_stuff">View Project</a>
</div>

<div style="border:1px solid #ddd; padding:15px; border-radius:10px;">
<h3>Forage Job Simulations</h3>
<p>Industry simulation projects from companies including JPMorgan, Quantium, and Tata Data Analytics.</p>
<a href="https://github.com/freakingdark/Forage_Job_Sim">View Project</a>
</div>
...
**M.Sc Physics**  
Ramniranjan Junjhunwala College, Mumbai  
...
[Download Resume](Deepali_PandeyResume.pdf)

---

# Contact

Email: deepalipandey711@gmail.com  

LinkedIn  
https://linkedin.com/in/pandey-deepali  

GitHub  
https://github.com/freakingdark
